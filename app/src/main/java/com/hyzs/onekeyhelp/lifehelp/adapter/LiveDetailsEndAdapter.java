...
public class LiveDetailsEndAdapter extends BaseAdapter {
    ...
    public LiveDetailsEndAdapter(Context mContext, List<HelpMeDetailsCommonBean.ComplateSeekHelpUserListCommonBean> Commonlistbean,
