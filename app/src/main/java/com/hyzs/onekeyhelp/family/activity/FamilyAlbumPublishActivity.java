...
public class FamilyAlbumPublishActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initDialog() {
        ...
        mChooseGroup = new AlertDialog.Builder(FamilyAlbumPublishActivity.this).create();
        mChooseGroup.show();
            ...
            public void onClick(View v) {
                switch (rg.getCheckedRadioButtonId()) {
                    case R.id.layout_dialog_life_help_all:
                        mGroupId = "0";
                        ToastUtils.showShort(FamilyAlbumPublishActivity.this, "选择所有人分组");
                        album_group.setText("所有人");
                        break;
                    case R.id.layout_dialog_life_help_family:
                        mGroupId = "1";
                        ToastUtils.showShort(FamilyAlbumPublishActivity.this, "选择家庭分组");
                        album_group.setText("家庭");
                        break;
                    case R.id.layout_dialog_life_help_friend:
                        mGroupId = "2";
                        ToastUtils.showShort(FamilyAlbumPublishActivity.this, "选择朋友分组");
                        album_group.setText("朋友");
                        break;
                    case R.id.layout_dialog_life_help_neighbor:
                        mGroupId = "3";
                        ToastUtils.showShort(FamilyAlbumPublishActivity.this, "选择邻居分组");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.activity_life_help_publish_nonePic:
                Album.startAlbum(FamilyAlbumPublishActivity.this, 100, 8, ContextCompat.getColor(this, R.color.color_1ccd9b), ContextCompat.getColor(this, R.color.color_1ccd9b));
                break;
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (pathList == null) {
                    ...
                    if (pathList.size() + Album.parseResult(data).size() > 8) {
                        ToastUtils.showShort(FamilyAlbumPublishActivity.this, "选择上传的图片不能大于8张，请删除后再选择");
                        return;
                    }
                ...
                ToastUtils.showShort(FamilyAlbumPublishActivity.this, "取消上传");
            }
        }
    }
        ...
        NetRequest.PictureUpRequest(param, new NetRequest.getDataCallback() {
            ...
            public void getData(String data) {
                ...
                try {
                    ...
                    Toast.makeText(FamilyAlbumPublishActivity.this, "获取数据异常，请稍后重试...", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void publishRequest() {
        ...
        param1.put("currId", MySharedPreferences.getUserId(FamilyAlbumPublishActivity.this));
        param1.put("GA_Content", mEdit.getText().toString());
        param1.put("GA_GroupID", getIntent().getStringExtra("familyId"));
        param1.put("AffixImgList", sb.toString());
        NetRequest.ParamPostRequest(PortUtil.FamilyAlbumPublish, param1, new NetRequest.getDataCallback() {
            @Override
            public void getData(String data) {
                MyResuceOkBean bean = new Gson().fromJson(UrlDecodeUtil.urlCode(data), MyResuceOkBean.class);
                if ("10000".equals(bean.getCode())) {
                    ToastUtils.showShort(FamilyAlbumPublishActivity.this, "发布成功");
                    setResult(1);
                    finish();
                } else ToastUtils.showShort(FamilyAlbumPublishActivity.this, "发布失败");
                dialog.dismiss();
            }
        });
    }
