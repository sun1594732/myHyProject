 ...
 */
public class MovableReleaseRecyclerAdapter extends RecyclerView.Adapter<MovableReleaseRecyclerAdapter.ImageViewHolder> {

    private Activity context;
    private List<String> mImagePathList;
    private MovableReleaseRecyclerAdapter adapter;
    private LayoutInflater mLayoutInflater;
    private Dialog mDeletePhotoDialog;
    private int PHOTO_POSITION = 0;

    public MovableReleaseRecyclerAdapter(Activity context) {
