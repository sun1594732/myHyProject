...
public class ServiceProjectDetailBean {
    ...
    /**
     * lifeServiceSPDetails : {"ID":1,"SPP_LS_ID":1,"SPP_Name":"专业擦玻璃","SPP_Desc":"专业擦玻璃简短描述","SPP_Price":135,"SPP_UseState":0,"SPP_AddTime":"1494295008","SPP_ApprovalState":0,"SPP_Img":"","SPP_IsTop":0,"SPP_Sort":0,"SPP_OriginalCost":170,"SPP_Unit":0,"SPP_ServiceObj":0,"SPP_DetailIntro":"专业擦玻璃详细解释"}
     * message : 正常
     * code : 10000
     */

    private LifeServiceSPDetailsBean lifeServiceSPDetails;
    private String message;
    private String code;

    public LifeServiceSPDetailsBean getLifeServiceSPDetails() {
        return lifeServiceSPDetails;
    }

    public void setLifeServiceSPDetails(LifeServiceSPDetailsBean lifeServiceSPDetails) {
        this.lifeServiceSPDetails = lifeServiceSPDetails;
    }
    ...
    public static class LifeServiceSPDetailsBean {
        /**
         * ID : 1
         * SPP_LS_ID : 1
         * SPP_Name : 专业擦玻璃
