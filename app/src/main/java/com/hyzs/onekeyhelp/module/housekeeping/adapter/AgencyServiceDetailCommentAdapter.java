...
public class AgencyServiceDetailCommentAdapter extends BaseAdapter {
    private Context mContext;
    private List<AgencyServiceDetailBean.UserCommentBean> list;

    public AgencyServiceDetailCommentAdapter(Context mContext, List<AgencyServiceDetailBean.UserCommentBean> list) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        AgencyServiceDetailBean.UserCommentBean bean = list.get(position);
