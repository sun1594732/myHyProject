...
import com.hyzs.onekeyhelp.carresuce.fragment.MyHelpFragment;
import com.hyzs.onekeyhelp.carresuce.fragment.MyResuceFragment;
import com.hyzs.onekeyhelp.carresuce.fragment.ResuecTroopsFragment;


import com.umeng.analytics.MobclickAgent;

public class CarResuceActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static String[] tabTitle = { "我的帮助","我的救援", "救援大队" }; // 标题
    ...
    public class TabFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int arg) {
            ...
            switch (arg) {
                case 0:
                    ft = new MyHelpFragment();
                    break;
                case 1:
                    ft = new MyResuceFragment();
                    break;
                case 2:
                    ft = new ResuecTroopsFragment();
                    break;
    ...
    protected int getLayoutId() {
        return R.layout.activity_car_resuce;
    }
