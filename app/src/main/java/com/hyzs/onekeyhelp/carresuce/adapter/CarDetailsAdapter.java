...
public class CarDetailsAdapter extends BaseAdapter {
    ...
    public CarDetailsAdapter(Context mContext, List<HelpOtherDetailsHelMeBean.MySeekHelpMoneyAllotListBean> listbean,
                             TextView tv_mayMoney, Double mayMoney, double[] ints, boolean isHelpOk) {  //没接口，没数据源
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (TextUtils.isEmpty(ListBean.getFace())) {
            vh.iv_face.setImageResource(R.mipmap.replace_hybb);
        } else
