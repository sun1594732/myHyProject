package com.hyzs.onekeyhelp.widget.view;
...
//    private int mLastY;
    ...
    public VRefresh(Context context, AttributeSet attrs) {
        ...
        mFooterView = LayoutInflater.from(context).inflate(R.layout.item_news_refresh, null, false);
    }
...
//            mListView.removeFooterView(mFooterView);
    ...
    public void onScroll(AbsListView absListView, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        if (visibleItemCount == totalItemCount) { //所有可见条目 == 全部条目时则取消刷新
            isLastRow = false;
            return;
        }
