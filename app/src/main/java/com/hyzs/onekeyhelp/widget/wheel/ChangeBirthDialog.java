package com.hyzs.onekeyhelp.widget.wheel;
...
import com.hyzs.onekeyhelp.widget.wheel.adapters.AbstractWheelTextAdapter;
import com.hyzs.onekeyhelp.widget.wheel.views.OnWheelChangedListener;
import com.hyzs.onekeyhelp.widget.wheel.views.OnWheelScrollListener;
import com.hyzs.onekeyhelp.widget.wheel.views.WheelView;
...
public class ChangeBirthDialog extends Dialog implements android.view.View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initHour();
		mHourdapter = new CalendarTextAdapter(context, arry_hour, currentHour - 1, maxTextSize, minTextSize);
		wvHour.setVisibleItems(5);
		wvHour.setViewAdapter(mHourdapter);
		wvHour.setCurrentItem(currentHour - 1);

		initMinute();
		mMinutedapter = new CalendarTextAdapter(context, arry_minute, currentMinute - 1, maxTextSize, minTextSize);
	...
	public void onClick(View v) {
		...
		if (v == btnSure) {
			if (onBirthListener != null) {
				onBirthListener.onClick(selectYear, selectMonth, selectDay,selectHour,selectMinute);
			}
		} else if (v == btnSure) {
...
//			this.month =
					getMonth();
			Log.e("ssssss", "setDate: "+this.month );
		} else {
			this.month = 12;
		}
