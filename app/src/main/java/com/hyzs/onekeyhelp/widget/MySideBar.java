...
public class MySideBar extends View {
    private final static int DEFAULT_TEXT_SIZE = 34; // sp
...
//        mTextSize = typedArray.getDimension(R.styleable.WaveSideBar_sidebar_text_size,DEFAULT_TEXT_SIZE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0, mIndexItemsLength = mIndexItems.length; i < mIndexItemsLength; i++) {
            ...
            scale = (i == mCurrentIndex) ? scale : 0;
            int alphaScale = (i == mCurrentIndex) ? (255) : (int) (255 * (1-scale));
            baseLineY = (i == mCurrentIndex) ? baseLineY -20 : baseLineY;
