...
public class IntentChatActivity extends AppCompatActivity implements EaseChatFragment.EaseChatFragmentHelper {
    private static final String TAG = "IntentChatActivity";
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String uId=getIntent().getStringExtra("one");
