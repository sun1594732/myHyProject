...
public class OpinionImageAdapter extends RecyclerView.Adapter<OpinionImageAdapter.ImageViewHolder> {
    ...
    public OpinionImageAdapter(Activity context,int sum) {
        ...
        if (position == mImagePathList.size()) {
            ...
            holder.mIvIcon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("limitCount",sum);
