...
public class MineChargeFragment extends Fragment {
...
//                initData();
    ...
    private void initData() {
        ...
        NetRequest.ParamPostRequest(PortUtil.ChargeCalendar, param, new NetRequest.getDataCallback() {
            @Override
            public void getData(String data) {
//                复用了消费的适配器用json解析填充实体类
                try {
                    ...
                    JSONArray array = object.getJSONArray("accountPayList");
