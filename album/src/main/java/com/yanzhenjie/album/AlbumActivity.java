...
public class AlbumActivity extends AppCompatActivity {
    ...
    private static int CHOOSED_PHOTO_NUMBER = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CHOOSED_PHOTO_NUMBER = intent.getIntExtra("picCount", 0);
        ...
        mAllowSelectCount = intent.getIntExtra("limitCount", 8);
    ...
    private OnCompatCompoundCheckListener mContentCheckListener = new OnCompatCompoundCheckListener() {
        ...
        public void onCheck(CompoundButton compoundButton, int position, boolean isChecked) {
            ...
            if ((hasCheckSize + CHOOSED_PHOTO_NUMBER) > mAllowSelectCount) {
