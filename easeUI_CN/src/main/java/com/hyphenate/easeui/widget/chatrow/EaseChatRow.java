...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        SharedPreferences sp = context.getSharedPreferences("MySharedPreferencesEdit", Context.MODE_PRIVATE);
        //set nickname and avatar
        if (message.direct() == Direct.SEND) {
            EaseUserUtils.setUserAvatar(context, sp.getString("myImg", ""), userAvatarView);
        } else {
            Log.e(TAG, "setUpBaseView: "+message.getStringAttribute("avatarURLPath", "") );

                EaseUserUtils.setUserAvatar(context, sp.getString(message.getFrom()+"otherImg", ""), userAvatarView);
