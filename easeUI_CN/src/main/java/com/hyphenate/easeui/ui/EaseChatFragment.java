...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        sp = getActivity().getSharedPreferences("MySharedPreferencesEdit", Context.MODE_PRIVATE);
    ...
    public void onMessageReceived(List<EMMessage> messages) {
        for (EMMessage message : messages) {
            ...
            // group message
            Log.e(TAG, "onMessageReceived: "+message.getUserName() );
            Log.e(TAG, "onMessageReceived: "+message.toString() );
            Log.e(TAG, "onMessageReceived: "+message.ext().values().toString() );
            Log.e(TAG, "onMessageReceived: "+message.ext().toString() );
            if (message.getChatType() == ChatType.GroupChat || message.getChatType() == ChatType.ChatRoom) {
                if (!message.getStringAttribute("avatarURLPath", "").equals(sp.getString(message.getFrom()+"otherImg",""))) {

                    SharedPreferences.Editor edit = sp.edit();
                    edit.putString(message.getFrom()+"otherImg", message.getStringAttribute("avatarURLPath", ""));
                    edit.commit();
                }
                username = message.getTo();
            } else {
                if (!sp.getString(message.getFrom()+"otherImg","").equals(sp.getString("Img",""))) {
                    SharedPreferences.Editor edit = sp.edit();
                    edit.putString(message.getFrom() + "otherImg", sp.getString("Img", ""));
                    edit.commit();
                }
                // single chat message
...
//                EaseUI.getInstance().getNotifier().onNewMsg(message);
    ...
    protected void sendMessage(EMMessage message){
        ...
        message.setAttribute("avatarURLPath",sp.getString("myImg",""));
        message.setAttribute("nickname",sp.getString("myName",""));
